...
$(document).ready(function () {
 ...
 // $(document).on('mousedown', '.keyboard-key', function (event) {
    ...
    //     // Temporarily treat number input as text to prevent formatting issues
    ...
    //     // Restore input type if it was a number input, after a delay to handle focus issues
    //     // if (inputField.data('wasNumber')) {
    //     //     setTimeout(function () {
